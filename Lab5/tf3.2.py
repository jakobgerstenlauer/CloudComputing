...
num_vectors = 10000
#Here we reduce the number of clusters from 3 to 2
num_clusters = 2
num_steps = 100
vector_values = []
...
plt.savefig("InputPointsClusterAnalysis_"+str(num_vectors)+".jpeg")
...
plt.savefig("ResultsClusterAnalysis_"+str(num_vectors)+".jpeg")
